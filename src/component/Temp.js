        ...
        <>
            <div className="container-fluid col-md-12 ">
                <div className="row col-md-8  m-auto justify-content-center">
                    ...
                    <div className="col-md-2 mt-5 mb-2">
                ...
                <div className="row col-md-8 m-auto">
                    <div className="card">
                        <div className="card-body ">
                            ...
                            <div className="col-md-12 bg-light d-flex flex-row  ">
                                <div className="col-md-8 bg-dark d-flex flex-row">
                                    {/* <div className="col mt-5">

                                    <strong >
                                    <h4 className="d-inline-block  display-4 text-white  ps-1">{tempdata.temp} &deg;</h4>
                                <h4 className='d-inline-block ps-5  display-4 text-white'>{tempdata.weatherType}</h4>
                                <div className="col-2 offset-3">
                                <p className='text-white' >{tempdata.name},{tempdata.country}</p>
                                </div>
                                    </strong>
                                </div> */}
                                    <div className="col-5">
                                    ...
                                    <div className="col-5 bg-secondary">
                                        <strong><h3 className=" display-3 text-white  p-4 ps-2 ">{tempdata.weatherType}</h3>
                                            <p className='text-white ps-2'>{tempdata.name} , {tempdata.country}</p>
                                        </strong>
                                    </div>
                                ...
                                <div className="position-relative col-md-4 timecol ">
                                    <div className="date">{date}</div>
                                </div>
                            </div>
                            

                            <div className="col-md-12 d-flex flex-row justify-content-between" id='card-footer'>
